  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={["bottom"]}>
      <ScrollView 
        ...
        contentContainerStyle={isTV ? { padding: getSpacing(16) } : undefined}
      >
        <View style={[styles.section, isTV && { marginBottom: getSpacing(32) }]}>
          <Text style={[
            styles.sectionTitle, 
            { 
              color: colors.text,
              fontSize: isTV ? getFontSize(22) : 18,
            ...
            <View style={[
              ...
              <Text style={[
                ...
                { 
                  ...
                  fontSize: isTV ? getFontSize(18) : 14
                }
              ]}>
              ...
              return (
                ...
                >
                  <View style={styles.playlistInfo}>
                    ...
                    <Text style={[styles.playlistUrl, { color: colors.textSecondary }]}>
                      {playlist.url}
                    </Text>
        ...
        {renderMenuButton(
          <Clock size={isTV ? 24 : 20} color={colors.text} style={styles.settingIcon} />,
          "Update Settings",
        ...
        {renderMenuButton(
          <Info size={isTV ? 24 : 20} color={colors.text} style={styles.settingIcon} />,
          "About",
          handleAbout,
          1
        )}
