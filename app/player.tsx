...
import { StyleSheet, View, Text, Pressable, ActivityIndicator, Platform, BackHandler } from "react-native";
            ...
            >
              <SafeAreaView edges={["bottom"]} style={styles.bottomControls}>
                <View style={styles.playbackControls}>
                  {renderControlButton(
                    status.isPlaying ? (
                      <Pause size={isTV ? 36 : 28} color={colors.white} />
                    ) : (
                      <Play size={isTV ? 36 : 28} color={colors.white} />
                    ),
                    togglePlayPause,
                    true
                  )}
                  ...
                  {renderControlButton(
                    muted ? (
                      <VolumeX size={isTV ? 28 : 24} color={colors.white} />
                    ) : (
                      <Volume2 size={isTV ? 28 : 24} color={colors.white} />
                    ),
                    toggleMute
                  )}
                  ...
                  {renderControlButton(
                    isFullscreen ? (
                      <Minimize2 size={isTV ? 28 : 24} color={colors.white} />
                    ) : (
                      <Maximize2 size={isTV ? 28 : 24} color={colors.white} />
                    ),
                    handleFullscreen,
                    false,
                    true
